            ...
            <div className='print-content'>
                <form className='form-container'>
                    ...
                    <div className=" d-flex flex-nowrap mb-2 justify-content-between align-items-center">
                            ...
                            <label className='fw-bold mb-0' style={{width:"auto"}} htmlFor="employdid">Emply. ID </label>                   
                            <input type="input" className="form-control  " style={{width:"5rem"}} id="employdid" />

                            <label className='fw-bold mb-0 ' style={{width:"auto"}} htmlFor='employname'>Emply. Name </label>

                            <input type="input" className="form-control "  style={{width:"15rem"}} id="employname" />



                            <label className='mb-0 fw-bold'  style={{width:"auto"}} htmlFor='date'>Date: </label>
                    ...
                    <div className="row mb-3 align-items-center form-group">
                        ...
                        <div className="col-10">
                            <input type="input" className="form-control text-uppercase" style={{width:"auto"}} id="plctag" />
                        </div>
                    </div>
