            ...
            <div className='print-content'>
                <form className='form-container'>
                    <div className='text-center'>
                        ...
                        <h3 >PLC MODIFICATION REQUEST FORM</h3>
                    </div>
                    <div className="row mb-3 justify-content-between align-items-center">
                        ...
                        <div className=" d-flex">
                            <p className='fw-bold'>Emply. ID </p>                   
                            <input type="input" className="form-control " id="employdid" />
                        </div>

                        <div className="col-2">
                            <p className='fw-bold'>Emply. Name </p>

                        </div>
                        <div className="col-auto">
                            <input type="input" className="form-control" id="employname" />
                        </div>
